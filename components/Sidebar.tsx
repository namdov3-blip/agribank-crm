...
import { LayoutDashboard, FolderKanban, Settings, Users, LogOut, ShieldCheck, Landmark } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, currentUser, onLogout }) => {
  ...
  const availableItems = menuItems.filter(item => 
    currentUser.permissions.includes(item.id) || currentUser.role === 'Admin'
  );
